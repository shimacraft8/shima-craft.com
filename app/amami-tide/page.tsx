  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description: "気象庁が公開する奄美（名瀬小湊）の2026年潮位表をもとに、毎時潮位、満潮・干潮の時刻と潮位をSHIMA CRAFTが観光客向けに整理・加工したデータセットです。",
        url: "https://shima-craft.com/amami-tide",
        ...
        creator: { "@type": "Organization", name: "SHIMA CRAFT", url: "https://shima-craft.com" },
        publisher: { "@type": "Organization", name: "SHIMA CRAFT", url: "https://shima-craft.com" },
        ...
        keywords: ["奄美大島", "名瀬小湊", "潮位", "潮見表", "満潮", "干潮", "2026年"],
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
