...
/** この粒状度スコアを超えたらデノイズを適用する（クリーンな写真は 2-4、粗い印刷スキャンは 9+） */
export const GRAIN_SCORE_THRESHOLD = 9;
/** このスコアを超える強粒状はブラーを2回適用する（過剰ブラーによる境界消失リスクを避けるため高めに設定） */
export const GRAIN_SCORE_HEAVY = 20;
